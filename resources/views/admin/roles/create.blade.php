...
<div class="max-w-4xl bg-white p-6 rounded shadow-sm border border-gray-200">
    <form method="POST" action="{{ route('admin.roles.store') }}" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700">Role Code (e.g. TECHNICAL)</label>
                ...
                <div class="p-3 bg-gray-50 border border-gray-200 rounded">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2">
                        ...
                        <label class="inline-flex items-center">
                            <input type="checkbox" name="permissions[]" value="{{ $p->id }}" class="rounded border-gray-300 text-sky-600">
        ...
        <div class="flex justify-end gap-2 pt-4 border-t">
            ...
            <button type="submit" class="px-4 py-2 bg-sky-600 text-white rounded text-sm font-medium">Save Role</button>
        </div>
    </form>
</div>
@endsection
